...
frame1 = Frame(root)
title =  Label(frame1,text="Calculate Area of Different Shapes",font=("arial",20,"bold"),fg="blue")
title.grid(row=0,column=0)
choice = Label(frame1,text="Select shape",font=("arial",14,),fg="blue")
...
frame2= Frame(root)
circle = Button(frame2,font=("calibri",12),text="Circle",bg="POWDER BLUE",command=calculation.circleMethod)
circle.grid(row=0,column=0)
square = Button(frame2,font=("calibri",12),text="Square",bg="Blue",command=calculation.squareMethod)
square.grid(row=0,column=1)
rectangle = Button(frame2,font=("calibri",12),text="Rectangle",bg="POWDER BLUE",command=calculation.rectangleMethod)
rectangle.grid(row=0,column=2)
triangle = Button(frame2,font=("calibri",12),text="Triangle",bg="Blue",command= calculation.triangleMethod)
